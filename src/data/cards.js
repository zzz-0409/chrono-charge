  ...
  const drivePool = [
    {
      ...
      text: "召喚条件：場かチャージの「星導」ユニット1枚と、場かチャージの任意の「星導」カード2枚をロストゾーンに送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。デッキから「星導」カード1枚を手札に加え、相手ユニット1体を手札に戻し、2枚ドローする。",
    },
    {
      id: "drive_star_core",
      name: "星導・天球儀",
      ...
      text: "発動条件：場かチャージの「星導」コア1枚と、場かチャージの任意の「星導」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドローする。自分の「星導」ユニットはATKを300アップする。1ターンに1度、このカードを選んで発動できる。1枚ドローする。",
    },
    {
      id: "drive_star_spell",
      name: "星導・流星招来",
      ...
      text: "発動条件：チャージの「星導」スペル1枚と、場かチャージの任意の「星導」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「星導」カードが3枚以上ならチャージ3を支払ってもよい。発動時：この効果を発動する。デッキから「星導」カード1枚を手札に加え、1枚ドローし、自分のチャージ2枚をアクティブにする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。ロストゾーンから「星導」カード1枚を自分のチャージに置く。置けないなら1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「星導」リアクション1枚と、場かチャージの任意の「星導」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「星導」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを手札に戻し、1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「星導」リアクション1枚と、場かチャージの任意の「星導」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「星導」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら持ち主の手札に戻す。ドライブカードならドライブデッキに戻す。その後、1枚ドローする。",
    },
    {
      id: "drive_black_unit",
      name: "黒機・殲滅機兵オルド",
      ...
      text: "召喚条件：場かチャージの「黒機」ユニット1枚と、場かチャージの任意の「黒機」カード2枚をロストゾーンに送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。相手に2000ダメージ。相手ユニット1体を破壊する。",
    },
    {
      id: "drive_black_core",
      name: "黒機・重圧炉",
      ...
      text: "発動条件：場かチャージの「黒機」コア1枚と、場かチャージの任意の「黒機」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手に1000ダメージ。自分の「黒機」ユニットはATKを300アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手に800ダメージ。",
    },
    {
      ...
      text: "発動条件：チャージの「黒機」スペル1枚と、場かチャージの任意の「黒機」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「黒機」カードが5枚以上ならチャージ5を支払ってもよい。発動時：この効果を発動する。相手ユニット1体と相手コア1枚を破壊し、相手に1500ダメージ。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手に600ダメージ。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「黒機」リアクション1枚と、場かチャージの任意の「黒機」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「黒機」カードが3枚以上ならチャージ3を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを破壊し、相手に1500ダメージ。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「黒機」リアクション1枚と、場かチャージの任意の「黒機」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「黒機」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら破壊する。その後、相手に1200ダメージ。",
    },
    {
      id: "drive_blade_unit",
      name: "断刃・終刃ヴァルク",
      ...
      text: "召喚条件：場かチャージの「断刃」ユニット1枚と、場かチャージの任意の「断刃」カード2枚をロストゾーンに送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。相手ユニットすべてを次の相手ターン終了まで行動済みにする。",
    },
    {
      id: "drive_blade_core",
      name: "断刃・審判台",
      ...
      text: "発動条件：場かチャージの「断刃」コア1枚と、場かチャージの任意の「断刃」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにする。自分の「断刃」ユニットはATKを300アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手の行動済みユニット1体を破壊する。破壊できなければ相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      ...
      text: "発動条件：チャージの「断刃」スペル1枚と、場かチャージの任意の「断刃」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「断刃」カードが5枚以上ならチャージ5を支払ってもよい。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにし、行動済みユニット1体を破壊する。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手ユニット1体を次の相手ターン終了まで行動済みにする。できなければ相手に500ダメージ。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「断刃」リアクション1枚と、場かチャージの任意の「断刃」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「断刃」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを次の相手ターン終了まで行動済みにし、その後そのユニットを破壊する。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「断刃」リアクション1枚と、場かチャージの任意の「断刃」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「断刃」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら破壊する。破壊できなければ相手の行動済みユニット1体を破壊する。それもできなければ相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      id: "drive_cyber_unit",
      name: "電脳・量子姫アリア",
      ...
      text: "召喚条件：場かチャージの「電脳」ユニット1枚と、場かチャージの任意の「電脳」カード2枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手のセットリアクション2枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      id: "drive_cyber_core",
      name: "電脳・量子中枢",
      ...
      text: "発動条件：場かチャージの「電脳」コア1枚と、場かチャージの任意の「電脳」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手のセットリアクション1枚を表向きにし、手札からコスト3以下の「電脳」ユニット1体を追加召喚できる。自分の「電脳」ユニットはATKを200アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      ...
      text: "発動条件：チャージの「電脳」スペル1枚と、場かチャージの任意の「電脳」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「電脳」カードが2枚以上ならチャージ2を支払ってもよい。発動時：この効果を発動する。相手のセットリアクションを2枚まで表向きにし、表向きのリアクション1枚をロストゾーンに送り、デッキから「電脳」カード1枚を手札に加え、1枚ドローする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。表向きにできなければ1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「電脳」リアクション1枚と、場かチャージの任意の「電脳」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「電脳」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「電脳」リアクション1枚と、場かチャージの任意の「電脳」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「電脳」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、相手のセットリアクション2枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      id: "drive_sosai_unit",
      name: "双彩・ヒカリ＆ミント",
    ...
    },
    {
      ...
      text: "発動条件：場かチャージの「双彩」コア1枚と、場かチャージの任意の「双彩」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドローする。自分の「双彩」ユニットは、相方がいるならATKを500アップする。1ターンに1度、このカードを選んで発動できる。1枚ドローする。自分フィールドに「双彩」のペアがいるなら自分のチャージ1枚をアクティブにする。",
    },
    {
      ...
      text: "発動条件：チャージの「双彩」スペル1枚と、場かチャージの任意の「双彩」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「双彩」カードが3枚以上ならチャージ3を支払ってもよい。発動時：この効果を発動する。ロストゾーンから「双彩」ユニット1体を手札に戻し、手札からコスト3以下の「双彩」ユニット1体を追加召喚できる。追加召喚したなら自分のチャージ1枚をアクティブにする。その後、1枚ドローする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。ロストゾーンから「双彩」ユニット1体を手札に戻す。戻せなければ1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「双彩」リアクション1枚と、場かチャージの任意の「双彩」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「双彩」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、1枚ドローする。自分フィールドに「双彩」のペアがいるならそのユニットを手札に戻す。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「双彩」リアクション1枚と、場かチャージの任意の「双彩」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「双彩」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、1枚ドローする。自分フィールドに「双彩」のペアがいるなら発動元が場のカードを持ち主の手札に戻す。ドライブカードならドライブデッキに戻す。",
    },
    {
      ...
      text: "召喚条件：場かチャージの「契環」ユニット1枚、場かチャージの「契環」スペル1枚、場かチャージの「契環」リアクション1枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。デッキから「契環」カード1枚を手札に加え、1枚ドローし、自分の「契環」ユニットすべてのATKを300アップする。",
    },
    {
      ...
      text: "発動条件：場かチャージの「契環」コア1枚と、場かチャージの任意の「契環」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドロー。自分の「契環」ユニットはATKを300アップする。1ターンに1度、このカードを選んで発動できる。ロストゾーンから「契環」カード1枚を自分のチャージに置く。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「契環」リアクション1枚と、場かチャージの任意の「契環」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「契環」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら持ち主の手札に戻す。戻せなければ1枚ドローする。",
    },
    {
