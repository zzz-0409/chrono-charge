(function () {
  ...
  const drivePool = [
    ...
    },
    {
      ...
      driveKind: "unit",
      driveCost: { materials: [{ theme: "月鏡", type: "ユニット", count: 2 }, { theme: "月鏡", count: 2 }] },
      driveEffect: "driveTsukikagamiUnit",
      text: "召喚条件：手札か場の「月鏡」ユニット2枚と、手札か場の任意の「月鏡」カード2枚をロストゾーンに送る。召喚時：この効果を発動できる。相手ユニット1体を手札に戻す。デッキから「月鏡」カード1枚を手札に加え、自分の「月鏡」ユニットすべてのATKを300アップする。",
    },
    {
