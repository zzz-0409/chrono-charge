  ...
  const drivePool = [
    {
      ...
      text: "召喚条件：場かチャージの「星導」ユニット1枚と、場かチャージの任意の「星導」カード2枚を墓地に送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。デッキから「星導」カード1枚を手札に加え、相手ユニット1体を手札に戻し、2枚ドローする。",
    },
    {
      id: "drive_star_core",
      name: "星導・天球儀",
      ...
      text: "発動条件：場かチャージの「星導」コア1枚と、場かチャージの任意の「星導」カード2枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドローする。自分の「星導」ユニットはATKを300アップする。1ターンに1度、このカードを選んで発動できる。1枚ドローする。",
    },
    {
      id: "drive_star_spell",
      name: "星導・流星招来",
    ...
    },
    {
      ...
      text: "召喚条件：場かチャージの「黒機」ユニット1枚と、場かチャージの任意の「黒機」カード2枚を墓地に送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。相手に2000ダメージ。相手ユニット1体を破壊する。",
    },
    {
      id: "drive_black_core",
      name: "黒機・重圧炉",
      ...
      text: "発動条件：場かチャージの「黒機」コア1枚と、場かチャージの任意の「黒機」カード2枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手に1000ダメージ。自分の「黒機」ユニットはATKを300アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手に800ダメージ。",
    },
    {
    ...
    },
    {
      ...
      text: "召喚条件：場かチャージの「断刃」ユニット1枚と、場かチャージの任意の「断刃」カード2枚を墓地に送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。相手ユニットすべてを次の相手ターン終了まで行動済みにする。",
    },
    {
      id: "drive_blade_core",
      name: "断刃・審判台",
      ...
      text: "発動条件：場かチャージの「断刃」コア1枚と、場かチャージの任意の「断刃」カード2枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにする。自分の「断刃」ユニットはATKを300アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手の行動済みユニット1体を破壊する。破壊できなければ相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
    ...
    },
    {
      ...
      text: "召喚条件：場かチャージの「電脳」ユニット1枚と、場かチャージの任意の「電脳」カード2枚を墓地に送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手のセットリアクション2枚を表向きにし、表向きのリアクション1枚を墓地に送る。",
    },
    {
      id: "drive_cyber_core",
      name: "電脳・量子中枢",
      ...
      text: "発動条件：場かチャージの「電脳」コア1枚と、場かチャージの任意の「電脳」カード2枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手のセットリアクション1枚を表向きにし、手札からコスト3以下の「電脳」ユニット1体を追加召喚できる。自分の「電脳」ユニットはATKを200アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚を墓地に送る。",
    },
    {
    ...
    },
    {
      ...
      text: "召喚条件：場の「双彩のヒカリ」と場の「双彩のミント」、チャージの任意の「双彩」カード1枚を墓地に送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。デッキから「双彩」ユニット1枚を手札に加え、相手ユニット1体を手札に戻す。",
    },
    {
      ...
      text: "召喚条件：場の「双彩のネネ」と場の「双彩のルリ」、チャージの任意の「双彩」カード1枚を墓地に送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手ユニット1体を手札に戻し、相手に1000ダメージ。1枚ドローする。",
    },
    {
      ...
      text: "召喚条件：場の「双彩のココ」と場の「双彩のルナ」、チャージの任意の「双彩」カード1枚を墓地に送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。自分のタップ済みチャージ2枚をアクティブにし、相手ユニット1体を破壊する。",
    },
    {
      id: "drive_sosai_core",
      name: "双彩・プリズムステージ",
      ...
      text: "発動条件：場かチャージの「双彩」コア1枚と、場かチャージの任意の「双彩」カード2枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドローする。自分の「双彩」ユニットは、相方がいるならATKを500アップする。1ターンに1度、このカードを選んで発動できる。1枚ドローする。自分フィールドに「双彩」のペアがいるなら自分のチャージ1枚をアクティブにする。",
    },
    {
    ...
    },
    {
      ...
      text: "召喚条件：場かチャージの「契環」ユニット1枚、場かチャージの「契環」スペル1枚、場かチャージの「契環」リアクション1枚を墓地に送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。デッキから「契環」カード1枚を手札に加え、1枚ドローし、自分の「契環」ユニットすべてのATKを300アップする。",
    },
    {
      ...
      text: "発動条件：場かチャージの「契環」コア1枚と、場かチャージの任意の「契環」カード2枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドロー。自分の「契環」ユニットはATKを300アップする。1ターンに1度、このカードを選んで発動できる。墓地から「契環」カード1枚を自分のチャージに置く。",
    },
    {
    ...
    },
    {
      ...
      text: "召喚条件：場のユニット1体とチャージのユニット1枚を墓地に送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      ...
      text: "発動条件：場のコア1枚とチャージのコア1枚を墓地に送り、さらにチャージ2を支払う。発動時：この効果を発動する。2枚ドローし、手札1枚を墓地に送る。1ターンに1度、このカードを選んで発動できる。1枚ドローし、手札1枚を墓地に送る。",
    },
    {
