(function () {
  ...
  const drivePool = [
    ...
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「星導」リアクション1枚と、場かチャージの任意の「星導」カード2枚を墓地に送る。効果：その攻撃を無効にし、1枚ドロー。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「星導」リアクション1枚と、場かチャージの任意の「星導」カード2枚を墓地に送る。効果：その効果を無効にし、2枚ドロー。",
    },
    {
      id: "drive_black_unit",
      name: "黒機・殲滅機兵オルド",
    ...
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「黒機」リアクション1枚と、場かチャージの任意の「黒機」カード2枚を墓地に送る。効果：その攻撃を無効にし、相手に1000ダメージ。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「黒機」リアクション1枚と、場かチャージの任意の「黒機」カード2枚を墓地に送る。効果：その効果を無効にし、相手に800ダメージ。",
    },
    {
      id: "drive_blade_unit",
      name: "断刃・終刃ヴァルク",
    ...
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場かチャージの「電脳」リアクション1枚と、場かチャージの任意の「電脳」カード2枚を墓地に送る。効果：その攻撃を無効にし、1枚ドロー。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場かチャージの「電脳」リアクション1枚と、場かチャージの任意の「電脳」カード2枚を墓地に送る。効果：その効果を無効にし、相手のセットリアクション1枚を表向きにして1枚ドロー。",
    },
    {
      id: "drive_sosai_unit",
      name: "双彩・ヒカリ＆ミント",
    ...
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、場のリアクション1枚とチャージのリアクション1枚を墓地に送る。効果：その攻撃を無効にする。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場のリアクション1枚とチャージのリアクション1枚を墓地に送る。効果：その効果を無効にする。",
    },
  ];
