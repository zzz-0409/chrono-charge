(function () {
  ...
  const cardPool = [
    ...
    },
    {
      ...
      text: "発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにする。自分のチャージに「契環」のカード種類が3種類以上あるなら、追加でロストゾーンから「契環」リアクション1枚を手札に戻せる。",
    },
    {
  ...
  const drivePool = [
    ...
    },
    {
      ...
      text: "発動条件：手札か場の「星導」スペル1枚と、手札か場の任意の「星導」カード1枚をロストゾーンに送る。発動時：この効果を発動する。デッキから「星導」カード1枚を手札に加え、1枚ドローし、自分のチャージ2枚をアクティブにする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。ロストゾーンから「星導」カード1枚を自分のチャージに置く。置けないなら1枚ドローする。",
    },
    {
    ...
    },
    {
      ...
      text: "発動条件：手札か場の「黒機」スペル1枚と、手札か場の任意の「黒機」カード2枚をロストゾーンに送る。発動時：この効果を発動する。相手ユニット1体と相手コア1枚を破壊し、相手に1500ダメージ。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手に600ダメージ。",
    },
    {
    ...
    },
    {
      ...
      text: "発動条件：手札か場の「断刃」スペル1枚と、手札か場の任意の「断刃」カード2枚をロストゾーンに送る。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにし、行動済みユニット1体を破壊する。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手ユニット1体を次の相手ターン終了まで行動済みにする。できなければ相手に500ダメージ。",
    },
    {
    ...
    },
    {
      ...
      text: "発動条件：手札か場の「電脳」スペル1枚と、手札か場の任意の「電脳」カード1枚をロストゾーンに送る。発動時：この効果を発動する。相手のセットリアクションを2枚まで表向きにし、表向きのリアクション1枚をロストゾーンに送り、デッキから「電脳」カード1枚を手札に加え、1枚ドローする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。表向きにできなければ1枚ドローする。",
    },
    {
    ...
    },
    {
      ...
      text: "発動条件：手札か場の「双彩」スペル1枚と、手札か場の任意の「双彩」カード1枚をロストゾーンに送る。発動時：この効果を発動する。ロストゾーンから「双彩」ユニット1体を手札に戻し、手札からコスト3以下の「双彩」ユニット1体を追加召喚できる。追加召喚したなら自分のチャージ1枚をアクティブにする。その後、1枚ドローする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。ロストゾーンから「双彩」ユニット1体を手札に戻す。戻せなければ1枚ドローする。",
    },
    {
    ...
    },
    {
      ...
      text: "召喚条件：手札か場のユニット1枚をロストゾーンに送る。召喚時：この効果を発動できる。相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      ...
      text: "発動条件：手札か場のコア1枚をロストゾーンに送る。発動時：この効果を発動する。2枚ドローし、手札1枚をロストゾーンに送る。1ターンに1度、このカードを選んで発動できる。1枚ドローし、手札1枚をロストゾーンに送る。",
    },
    {
      ...
      text: "発動条件：手札か場のスペル1枚をロストゾーンに送る。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにし、行動済みユニット1体を破壊する。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。1枚ドローし、手札1枚をロストゾーンに送る。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、手札か場のリアクション1枚をロストゾーンに送る。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを次の相手ターン終了まで行動済みにする。自分のチャージ1枚をアクティブにする。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、手札か場のリアクション1枚をロストゾーンに送る。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら破壊する。破壊できなければ1枚ドローする。",
    },
  ];
