(function () {
  ...
  const cardPool = [
    ...
    },
    {
      ...
      effect: "starReignite",
      text: "発動時：この効果を発動する。ロストゾーンから「星導」と名のつくカード1枚を手札に戻す。自分の「星導」チャージ1枚をアクティブにする。",
    },
    {
      id: "star_orbit",
      name: "星導の軌道環",
    ...
    },
    {
      ...
      effect: "starChart",
      text: "発動時：この効果を発動する。ロストゾーンから「星導」と名のつくカード1枚を自分のチャージに置く。自分フィールドに「星導」ユニットがいるなら、追加で自分のチャージ1枚をアクティブにできる。",
    },
    {
    ...
    },
    {
      ...
      text: "発動時：この効果を発動する。ロストゾーンから、自分フィールドにいる「双彩のヒカリ」/「双彩のミント」、「双彩のネネ」/「双彩のルリ」、「双彩のココ」/「双彩のルナ」の相方1枚を手札に戻す。戻したなら、追加で自分のタップ済みチャージ1枚をアクティブにできる。",
    },
    {
    ...
    },
    {
      ...
      text: "発動時：この効果を発動する。デッキから「契環」ユニット1枚を手札に加える。追加で手札から「契環」カード1枚を自分のチャージに置ける。",
    },
    {
      id: "keikan_oath_contract",
      name: "契環の誓約契約",
      type: "スペル",
      attr: "光",
      cost: 1,
    ...
    },
    {
      ...
      text: "発動時：この効果を発動する。ロストゾーンから「契環」カード1枚を自分のチャージに置く。置いた後、自分のチャージに「契環」のカード種類が3種類以上あるなら、追加で1枚ドローできる。",
    },
    {
    ...
    },
    {
      ...
      text: "発動時：この効果を発動する。1枚ドロー。その後、自分の手札が3枚以下なら、追加で手札1枚を自分のチャージに置ける。",
    },
    {
    ...
    },
    {
      ...
      effect: "drawDiscard",
      text: "発動時：この効果を発動する。2枚ドロー。その後、手札1枚をロストゾーンに送る。",
    },
    {
    ...
    },
    {
      ...
      effect: "recallUnit",
      text: "発動時：この効果を発動する。ロストゾーンからユニット1体を手札に戻す。",
    },
    {
      id: "generic_zero",
      name: "ゼロシフト装置",
  ...
  const drivePool = [
    {
      ...
      text: "召喚条件：手札か場の「星導」ユニット1枚と、手札か場の任意の「星導」カード2枚をロストゾーンに送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。デッキから「星導」カード1枚を手札に加え、相手ユニット1体を手札に戻し、2枚ドローする。",
    },
    {
      id: "drive_star_core",
      name: "星導・天球儀",
      ...
      text: "発動条件：手札か場の「星導」コア1枚と、手札か場の任意の「星導」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドローする。自分の「星導」ユニットはATKを300アップする。1ターンに1度、このカードを選んで発動できる。1枚ドローする。",
    },
    {
      id: "drive_star_spell",
      name: "星導・流星招来",
      ...
      text: "発動条件：チャージの「星導」スペル1枚と、手札か場の任意の「星導」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「星導」カードが3枚以上ならチャージ3を支払ってもよい。発動時：この効果を発動する。デッキから「星導」カード1枚を手札に加え、1枚ドローし、自分のチャージ2枚をアクティブにする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。ロストゾーンから「星導」カード1枚を自分のチャージに置く。置けないなら1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、手札か場の「星導」リアクション1枚と、手札か場の任意の「星導」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「星導」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを手札に戻し、1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、手札か場の「星導」リアクション1枚と、手札か場の任意の「星導」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「星導」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら持ち主の手札に戻す。ドライブカードならドライブデッキに戻す。その後、1枚ドローする。",
    },
    {
      id: "drive_black_unit",
      name: "黒機・殲滅機兵オルド",
      ...
      text: "召喚条件：手札か場の「黒機」ユニット1枚と、手札か場の任意の「黒機」カード2枚をロストゾーンに送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。相手に2000ダメージ。相手ユニット1体を破壊する。",
    },
    {
      id: "drive_black_core",
      name: "黒機・重圧炉",
      ...
      text: "発動条件：手札か場の「黒機」コア1枚と、手札か場の任意の「黒機」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手に1000ダメージ。自分の「黒機」ユニットはATKを300アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手に800ダメージ。",
    },
    {
      ...
      text: "発動条件：チャージの「黒機」スペル1枚と、手札か場の任意の「黒機」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「黒機」カードが5枚以上ならチャージ5を支払ってもよい。発動時：この効果を発動する。相手ユニット1体と相手コア1枚を破壊し、相手に1500ダメージ。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手に600ダメージ。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、手札か場の「黒機」リアクション1枚と、手札か場の任意の「黒機」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「黒機」カードが3枚以上ならチャージ3を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを破壊し、相手に1500ダメージ。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、手札か場の「黒機」リアクション1枚と、手札か場の任意の「黒機」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「黒機」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら破壊する。その後、相手に1200ダメージ。",
    },
    {
      id: "drive_blade_unit",
      name: "断刃・終刃ヴァルク",
      ...
      text: "召喚条件：手札か場の「断刃」ユニット1枚と、手札か場の任意の「断刃」カード2枚をロストゾーンに送り、さらにチャージ4を支払う。召喚時：この効果を発動できる。相手ユニットすべてを次の相手ターン終了まで行動済みにする。",
    },
    {
      id: "drive_blade_core",
      name: "断刃・審判台",
      ...
      text: "発動条件：手札か場の「断刃」コア1枚と、手札か場の任意の「断刃」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにする。自分の「断刃」ユニットはATKを300アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手の行動済みユニット1体を破壊する。破壊できなければ相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      ...
      text: "発動条件：チャージの「断刃」スペル1枚と、手札か場の任意の「断刃」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「断刃」カードが5枚以上ならチャージ5を支払ってもよい。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにし、行動済みユニット1体を破壊する。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手ユニット1体を次の相手ターン終了まで行動済みにする。できなければ相手に500ダメージ。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、手札か場の「断刃」リアクション1枚と、手札か場の任意の「断刃」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「断刃」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを次の相手ターン終了まで行動済みにし、その後そのユニットを破壊する。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、手札か場の「断刃」リアクション1枚と、手札か場の任意の「断刃」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「断刃」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら破壊する。破壊できなければ相手の行動済みユニット1体を破壊する。それもできなければ相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      id: "drive_cyber_unit",
      name: "電脳・量子姫アリア",
      ...
      text: "召喚条件：手札か場の「電脳」ユニット1枚と、手札か場の任意の「電脳」カード2枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手のセットリアクション2枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      id: "drive_cyber_core",
      name: "電脳・量子中枢",
      ...
      text: "発動条件：手札か場の「電脳」コア1枚と、手札か場の任意の「電脳」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。相手のセットリアクション1枚を表向きにし、手札からコスト3以下の「電脳」ユニット1体を追加召喚できる。自分の「電脳」ユニットはATKを200アップする。1ターンに1度、このカードを選び、チャージ1を支払って発動できる。相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      ...
      text: "発動条件：チャージの「電脳」スペル1枚と、手札か場の任意の「電脳」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「電脳」カードが2枚以上ならチャージ2を支払ってもよい。発動時：この効果を発動する。相手のセットリアクションを2枚まで表向きにし、表向きのリアクション1枚をロストゾーンに送り、デッキから「電脳」カード1枚を手札に加え、1枚ドローする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。表向きにできなければ1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、手札か場の「電脳」リアクション1枚と、手札か場の任意の「電脳」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「電脳」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、相手のセットリアクション1枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、手札か場の「電脳」リアクション1枚と、手札か場の任意の「電脳」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「電脳」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、相手のセットリアクション2枚を表向きにし、表向きのリアクション1枚をロストゾーンに送る。",
    },
    {
      id: "drive_sosai_unit",
      name: "双彩・ヒカリ＆ミント",
      ...
      text: "召喚条件：場の「双彩のヒカリ」と場の「双彩のミント」、チャージの任意の「双彩」カード1枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。デッキから「双彩」ユニット1枚を手札に加え、相手ユニット1体を手札に戻す。",
    },
    {
      ...
      text: "召喚条件：場の「双彩のネネ」と場の「双彩のルリ」、チャージの任意の「双彩」カード1枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手ユニット1体を手札に戻し、相手に1000ダメージ。1枚ドローする。",
    },
    {
      ...
      text: "召喚条件：場の「双彩のココ」と場の「双彩のルナ」、チャージの任意の「双彩」カード1枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。自分のタップ済みチャージ2枚をアクティブにし、相手ユニット1体を破壊する。",
    },
    {
      id: "drive_sosai_core",
      name: "双彩・プリズムステージ",
      ...
      text: "発動条件：手札か場の「双彩」コア1枚と、手札か場の任意の「双彩」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドローする。自分の「双彩」ユニットは、相方がいるならATKを500アップする。1ターンに1度、このカードを選んで発動できる。1枚ドローする。自分フィールドに「双彩」のペアがいるなら自分のチャージ1枚をアクティブにする。",
    },
    {
      ...
      text: "発動条件：チャージの「双彩」スペル1枚と、手札か場の任意の「双彩」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「双彩」カードが3枚以上ならチャージ3を支払ってもよい。発動時：この効果を発動する。ロストゾーンから「双彩」ユニット1体を手札に戻し、手札からコスト3以下の「双彩」ユニット1体を追加召喚できる。追加召喚したなら自分のチャージ1枚をアクティブにする。その後、1枚ドローする。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。ロストゾーンから「双彩」ユニット1体を手札に戻す。戻せなければ1枚ドローする。",
    },
    {
      ...
      text: "発動条件：相手ユニットの攻撃宣言時、手札か場の「双彩」リアクション1枚と、手札か場の任意の「双彩」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「双彩」カードが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、1枚ドローする。自分フィールドに「双彩」のペアがいるならそのユニットを手札に戻す。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、手札か場の「双彩」リアクション1枚と、手札か場の任意の「双彩」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「双彩」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、1枚ドローする。自分フィールドに「双彩」のペアがいるなら発動元が場のカードを持ち主の手札に戻す。ドライブカードならドライブデッキに戻す。",
    },
    {
      ...
      text: "召喚条件：手札か場の「契環」ユニット1枚、手札か場の「契環」スペル1枚、手札か場の「契環」リアクション1枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。デッキから「契環」カード1枚を手札に加え、1枚ドローし、自分の「契環」ユニットすべてのATKを300アップする。",
    },
    {
      ...
      driveKind: "core",
      driveCost: { materials: [{ theme: "契環", type: "コア", count: 1 }, { theme: "契環", count: 2 }] },
      driveEffect: "driveKeikanCore",
      text: "発動条件：手札か場の「契環」コア1枚と、手札か場の任意の「契環」カード2枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。1枚ドロー。自分の「契環」ユニットはATKを300アップする。1ターンに1度、このカードを選んで発動できる。ロストゾーンから「契環」カード1枚を自分のチャージに置く。",
    },
    {
      ...
      trigger: "effect",
      driveKind: "reaction",
      driveCost: { materials: [{ theme: "契環", type: "リアクション", count: 1 }, { theme: "契環", count: 2 }] },
      driveEffect: "driveKeikanReactEffect",
      text: "発動条件：相手がカード効果を発動した時、手札か場の「契環」リアクション1枚と、手札か場の任意の「契環」カード2枚をロストゾーンに送る。または、自分のチャージゾーンの「契環」カードが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら持ち主の手札に戻す。戻せなければ1枚ドローする。",
    },
    {
      ...
      driveKind: "unit",
      driveCost: { materials: [{ type: "ユニット", source: "field", count: 1 }, { type: "ユニット", source: "charge", count: 1 }] },
      driveEffect: "driveGenericUnit",
      text: "召喚条件：場のユニット1体とチャージのユニット1枚をロストゾーンに送り、さらにチャージ3を支払う。召喚時：この効果を発動できる。相手ユニット1体を次の相手ターン終了まで行動済みにする。",
    },
    {
      ...
      driveKind: "core",
      driveCost: { materials: [{ type: "コア", source: "field", count: 1 }, { type: "コア", source: "charge", count: 1 }] },
      driveEffect: "driveGenericCore",
      text: "発動条件：場のコア1枚とチャージのコア1枚をロストゾーンに送り、さらにチャージ2を支払う。発動時：この効果を発動する。2枚ドローし、手札1枚をロストゾーンに送る。1ターンに1度、このカードを選んで発動できる。1枚ドローし、手札1枚をロストゾーンに送る。",
    },
    {
      ...
      driveKind: "spell",
      driveCost: { materials: [{ type: "スペル", source: "charge", count: 2 }] },
      driveEffect: "driveGenericSpell",
      text: "発動条件：チャージのスペル2枚をロストゾーンに送る。または、自分のチャージゾーンのスペルが2枚以上ならチャージ2を支払ってもよい。発動時：この効果を発動する。相手ユニット1体を次の相手ターン終了まで行動済みにし、行動済みユニット1体を破壊する。ロスト効果：このカードをロストゾーンからアビスゾーンに送って発動できる。1枚ドローし、手札1枚をロストゾーンに送る。",
    },
    {
      ...
      trigger: "attack",
      driveKind: "reaction",
      driveCost: { materials: [{ type: "リアクション", source: "field", count: 1 }, { type: "リアクション", source: "charge", count: 1 }] },
      driveEffect: "driveGenericReactAttack",
      text: "発動条件：相手ユニットの攻撃宣言時、場のリアクション1枚とチャージのリアクション1枚をロストゾーンに送る。または、自分のチャージゾーンのリアクションが2枚以上ならチャージ2を支払ってもよい。この効果は無効化されない。効果：その攻撃を無効にし、そのユニットを次の相手ターン終了まで行動済みにする。自分のチャージ1枚をアクティブにする。",
    },
    {
      ...
      text: "発動条件：相手がカード効果を発動した時、場のリアクション1枚とチャージのリアクション1枚をロストゾーンに送る。または、自分のチャージゾーンのリアクションが4枚以上ならチャージ4を支払ってもよい。この効果は無効化されない。効果：その効果を無効にし、発動元が場のカードなら破壊する。破壊できなければ1枚ドローする。",
    },
  ];
