    ...
    async resolve(effect, player, opponent, sourceCard) {
      switch (effect) {
        case "starScout":
          ...
          if (this.game.countThemeInCharge(player, "星導") >= 2) this.game.drawCards(player, 1);
          break;
        case "starLux":
        ...
        case "blackGrinder":
          ...
          if (player.cores.some(Boolean)) this.game.drawCards(player, 1);
          break;
        case "blackGear":
        ...
        case "blackRaid":
          ...
          if (this.game.controlsThemeUnit(player, "黒機")) this.game.exhaustBestUnit(opponent);
          break;
        case "drawDiscard":
